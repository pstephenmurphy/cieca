...
/**
 * <p>Java class for InspectionDescriptionClosedEnumType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="InspectionDescriptionClosedEnumType">
 ...
 * 
 */
@XmlType(name = "InspectionDescriptionClosedEnumType")
@XmlEnum
public enum InspectionDescriptionClosedEnumType {
    ...
    InspectionDescriptionClosedEnumType(String v) {
        value = v;
    }
    ...
    public static InspectionDescriptionClosedEnumType fromValue(String v) {
        for (InspectionDescriptionClosedEnumType c: InspectionDescriptionClosedEnumType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
