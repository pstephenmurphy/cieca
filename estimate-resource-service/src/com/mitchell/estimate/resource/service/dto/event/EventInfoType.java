...
import com.mitchell.estimate.resource.service.dto.admin.AdminInfoType;
import com.mitchell.estimate.resource.service.dto.event.appointment.AppointmentEventType;
import com.mitchell.estimate.resource.service.dto.event.appointment.AppointmentSlotsType;
import com.mitchell.estimate.resource.service.dto.event.repairorder.RepairOrderEventsType;
 ...
 *         &lt;element name="RepairOrderEvents" type="{http://www.cieca.com/BMS}RepairOrderEventsType" minOccurs="0"/>
 *         &lt;element name="AdminInfo" type="{http://www.cieca.com/BMS}AdminInfoType" minOccurs="0"/>
 *         &lt;element name="AppointmentEvent" type="{http://www.cieca.com/BMS}AppointmentEventType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AppointmentSlots" type="{http://www.cieca.com/BMS}AppointmentSlotsType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class EventInfoType implements Serializable
{
    ...
    @XmlElement(name = "RepairOrderEvents")
    protected RepairOrderEventsType repairOrderEvents;
    @XmlElement(name = "AdminInfo")
    protected AdminInfoType adminInfo;
    @XmlElement(name = "AppointmentEvent")
    protected List<AppointmentEventType> appointmentEvent;
    @XmlElement(name = "AppointmentSlots")
    protected AppointmentSlotsType appointmentSlots;
    ...
    /**
     * Gets the value of the repairOrderEvents property.
     * 
     * @return
     *     possible object is
     *     {@link RepairOrderEventsType }
     *     
     */
    public RepairOrderEventsType getRepairOrderEvents() {
        return repairOrderEvents;
    }

    /**
     * Sets the value of the repairOrderEvents property.
     * 
     * @param value
     *     allowed object is
     *     {@link RepairOrderEventsType }
     *     
     */
    public void setRepairOrderEvents(RepairOrderEventsType value) {
        this.repairOrderEvents = value;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the appointmentEvent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAppointmentEvent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AppointmentEventType }
     * 
     * 
     */
    public List<AppointmentEventType> getAppointmentEvent() {
        if (appointmentEvent == null) {
            appointmentEvent = new ArrayList<AppointmentEventType>();
        }
     ...
     * @return
     *     possible object is
     *     {@link AppointmentSlotsType }
     *     
     */
    public AppointmentSlotsType getAppointmentSlots() {
        return appointmentSlots;
    }

    /**
     * Sets the value of the appointmentSlots property.
     * 
     * @param value
     *     allowed object is
     *     {@link AppointmentSlotsType }
     *     
     */
    public void setAppointmentSlots(AppointmentSlotsType value) {
        this.appointmentSlots = value;
    }
