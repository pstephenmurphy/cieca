...
package com.mitchell.estimate.resource.service.dto.damage;
    ...
    implements Serializable
{
    ...
    protected List<String> lineItemCategoryCode;
    @XmlElement(name = "LineItemMotorcycleCategory")
    protected List<String> lineItemMotorcycleCategory;
     ...
     * 
     */
    public List<String> getLineItemCategoryCode() {
        if (lineItemCategoryCode == null) {
            lineItemCategoryCode = new ArrayList<String>();
        }
     ...
     * 
     */
    public List<String> getLineItemMotorcycleCategory() {
        if (lineItemMotorcycleCategory == null) {
            lineItemMotorcycleCategory = new ArrayList<String>();
        }
