 ...
 *       &lt;sequence>
 *         &lt;element name="DocAttachment" type="{http://www.cieca.com/BMS}DocAttachmentType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "DocAttachment")
    protected List<DocAttachmentType> docAttachment;
     ...
     * {@link DocAttachmentType }
     * 
     * 
     */
    public List<DocAttachmentType> getDocAttachment() {
        if (docAttachment == null) {
            docAttachment = new ArrayList<DocAttachmentType>();
        }
