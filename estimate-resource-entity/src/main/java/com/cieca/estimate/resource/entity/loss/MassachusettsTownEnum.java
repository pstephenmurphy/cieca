...
/**
 * <p>Java class for MassachusettsTownEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="MassachusettsTownEnum">
 ...
 * 
 */
@XmlType(name = "MassachusettsTownEnum")
@XmlEnum
public enum MassachusettsTownEnum {
    ...
    MassachusettsTownEnum(String v) {
        value = v;
    }
    ...
    public static MassachusettsTownEnum fromValue(String v) {
        for (MassachusettsTownEnum c: MassachusettsTownEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
